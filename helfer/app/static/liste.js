...
(function () {
  ...
  /* Hinweis: fast wortgleich mit presse/app/static/liste.js. Der Unterschied
   * ist sortwert() weiter unten – hier stehen Datumsspalten in der Tabelle,
   * die sich nicht nach ihrem sichtbaren Text ordnen lassen. */
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    /* Was in der Zelle steht, taugt nicht immer zum Sortieren: "Sa 29.08."
     * käme alphabetisch vor "So 30.08.", aber "Do 27.08." erst danach. Trägt
     * die Zelle ein data-wert, gilt das – sonst der sichtbare Text. */
    function sortwert(zelle) {
      if (!zelle) {
        return "";
      }
      var eigen = zelle.getAttribute("data-wert");
      return eigen === null ? zelle.textContent : eigen;
    }

    function sortieren(spalte, absteigend) {
      var sortiert = zeilen.slice().sort(function (a, b) {
        return vergleiche(
          sortwert(a.element.cells[spalte]),
          sortwert(b.element.cells[spalte]),
          absteigend
        );
      });
